...
@SpringBootTest
public class EnviromentDbConfigTest {
    ...
    @Test
    void shouldDataSourceNotNull_When_EnviromentConfigurationsNotNull() throws SQLException {
        assertNotNull(environmentDbConfig.dataSource());
    }

    @Test
    void shoudGetCurrentDateFromH2Db_When_DataSourceIsNotNull() throws SQLException {
